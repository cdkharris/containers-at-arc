...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', 'learner_page.html']

# The name of the Pygments (syntax highlighting) style to use.
pygments_style = None

# TACC logo
html_logo = 'images/UCL-Advanced-Research-Computing-WHT.svg'
...
html_static_path = ['_static', 'images/opor4-03_0.png']
