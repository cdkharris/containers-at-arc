...
1) Install Docker on your laptop:
  ...
  - `Windows <https://docs.docker.com/desktop/install/windows-install/>`_
      - `Microsoft documentation on installing WSL <https://learn.microsoft.com/en-us/windows/wsl/install>`_
      - `Microsoft documentation on installing Docker <https://learn.microsoft.com/en-us/windows/wsl/tutorials/wsl-containers>`_
